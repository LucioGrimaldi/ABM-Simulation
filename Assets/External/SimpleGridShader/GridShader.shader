...
Shader "PDT Shaders/TestGrid" {
	Properties {
		...
		_SelectedColor ("Selected Color", Color) = (1,0,0,1) //colora la cella
		...
		[IntRange] _SelectedCellX("Selected Cell X", Range(0,499)) = 0.0
		[IntRange] _SelectedCellY("Selected Cell Y", Range(0,499)) = 0.0

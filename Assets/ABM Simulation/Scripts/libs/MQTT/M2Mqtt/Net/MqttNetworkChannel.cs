...
namespace uPLibrary.Networking.M2Mqtt
{
    ...
    public class MqttNetworkChannel : IMqttNetworkChannel
    {
        ...
        // CA certificate (on MQTTSimClient)
        private X509Certificate caCert;
        // Server certificate (on broker)
        private X509Certificate serverCert;
        // MQTTSimClient certificate (on MQTTSimClient)
        ...
        /// Constructor
        /// </summary>
        /// <param name="socket">Socket opened with the MQTTSimClient</param>
        ...
        /// <summary>
        /// Accept connection from a remote MQTTSimClient
        /// </summary>
        public void Accept()
        {
#if SSL

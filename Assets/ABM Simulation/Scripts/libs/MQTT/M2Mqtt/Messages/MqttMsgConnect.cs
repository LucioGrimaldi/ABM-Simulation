...
{
    /// <summary>
    /// Class for CONNECT message from MQTTSimClient to broker
    /// </summary>
    public class MqttMsgConnect : MqttMsgBase
    {
        ...
        // max length for MQTTSimClient id (removed in 3.1.1)
        ...
        public static MqttMsgConnect Parse(byte fixedHeaderFirstByte, byte protocolVersion, IMqttNetworkChannel channel)
        {
            ...
            // MQTTSimClient identifier [v3.1.1] it may be zero bytes long (empty string)
            ...
            // [v3.1.1] if MQTTSimClient identifier is zero bytes long, clean session must be true
        ...
        public override byte[] GetBytes(byte protocolVersion)
        {
            ...
            // MQTTSimClient identifier field size
